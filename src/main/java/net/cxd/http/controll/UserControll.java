...
import net.cxd.http.Service.impl.BaseServiceImpl;
...
public class UserControll {
	...
	public String addFriendGroup(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) {
		getBaseService().addFriendGroup(request, response);
		return null;
	}
	@RequestMapping(value = "/deleteFriendGroup")
	public String deleteFriendGroup(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) {
	...
	public String moveFriendToOtherGroup(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) {
